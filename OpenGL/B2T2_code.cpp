...
int main()
{
    ...
    unsigned int diffuseMap[cantidadTexturas];
    unsigned int specularMap[cantidadTexturas];
    unsigned int emissionMap[cantidadTexturas];
    ...
    for (int i = 0; i < cantidadTexturas; i++) {
      /*  glGenTextures(1, &textures[i]);
        ...
        */std::string ruta = "textures/" + imagenesJpg[i] + ".jpg";
        diffuseMap[i] = specularMap[i] = emissionMap[i] = loadTexture(ruta.c_str());
        ...
        for (unsigned int i = 0; i < cantidadTexturas; i++)
        {
          ...
          /*  model = glm::translate(model, lightPos);
            ...
            */
            ...
            glBindTexture(GL_TEXTURE_2D, specularMap[i]);

            // bind emission map
            glActiveTexture(GL_TEXTURE2);
            glBindTexture(GL_TEXTURE_2D, emissionMap[i]);
