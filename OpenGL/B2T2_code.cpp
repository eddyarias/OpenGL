...
int main()
{
    ...
    float vertices[] = {
        ...
        -0.5f, -0.5f, 0.5f, 0.533f, 0.5f,      //a
        0.5f, -0.5f, 0.5f, 0.724f,  0.5f,       //b
        0.5f,  0.5f, 0.5f, 0.724f, 0.326f,      //c
        -0.5f,  0.5f, 0.5f, 0.533f, 0.326f,     //d
        0.5f,  0.5f, 0.5f, 0.724f, 0.326f,      //c
        -0.5f, -0.5f, 0.5f, 0.533f, 0.5f,       //a

        -0.5f, -0.5f, -0.5f, 0.338f, 0.5f,        //h
         -0.5f, -0.5f, 0.5f, 0.533f, 0.5f,       //a    
         -0.5f,  0.5f, 0.5f, 0.533f, 0.326f,     //d
         -0.5f,  0.5f, -0.5f, 0.338f, 0.326f,     //g
         -0.5f, -0.5f, -0.5f, 0.338f, 0.5f,        //h
         -0.5f,  0.5f, 0.5f, 0.533f, 0.326f,     //d
         
         0.5f,  0.5f, 0.5f, 0.724f, 0.326f,      //c
         0.5f, -0.5f, 0.5f, 0.724f,  0.5f,       //b
         0.5f,  0.5f, -0.5f, 0.925f, 0.326f,     //e
         0.5f, -0.5f, -0.5f, 0.925f, 0.5f,      //f
         0.5f, -0.5f, 0.5f, 0.724f,  0.5f,       //b
         0.5f,  0.5f, -0.5f, 0.925f, 0.326f,     //e

        -0.5f, -0.5f, 0.5f, 0.533f, 0.5f,       //a    
         0.5f, -0.5f, 0.5f, 0.724f,  0.5f,       //b
         -0.5f, -0.5f, -0.5f, 0.533f, 0.745f,    //h
         0.5f, -0.5f, -0.5f, 0.724f, 0.745f,     //f
         0.5f, -0.5f, 0.5f, 0.724f,  0.5f,       //b
         -0.5f, -0.5f, -0.5f, 0.533f, 0.745f,    //h

          0.5f,  0.5f, -0.5f, 0.143f, 0.326f,     //e
         -0.5f,  0.5f, -0.5f, 0.339f, 0.326f,     //g
         0.5f, -0.5f, -0.5f, 0.143f, 0.5f,       //f
         -0.5f, -0.5f, -0.5f, 0.369f, 0.5f,       //h
         -0.5f,  0.5f, -0.5f, 0.339f, 0.326f,     //g
         0.5f, -0.5f, -0.5f, 0.143f, 0.5f,       //f

         -0.5f,  0.5f, -0.5f, 0.533f, 0.079f,
         0.5f,  0.5f, -0.5f, 0.729f, 0.079f,
         -0.5f,  0.5f, 0.5f, 0.533f, 0.326f,
         0.5f,  0.5f, 0.5f, 0.729f, 0.326f,
         0.5f,  0.5f, -0.5f, 0.729f, 0.079f,
         -0.5f,  0.5f, 0.5f, 0.533f, 0.326f,
    };
